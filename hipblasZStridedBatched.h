#ifndef HIPBLAS_ZSTRIDEDBATCHED_H
#define HIPBLAS_ZSTRIDEDBATCHED_H 1
      interface

        subroutine hipblasCreate() bind(c,name='hipblasCreate_')
        end subroutine hipblasCreate

        subroutine hipblasDestroy() bind(c,name='hipblasDestroy_')
        end subroutine hipblasDestroy

        subroutine hipblasZgetrsStridedBatched(n,nrhs,c_trans,            &
     &      dA,ldA,strideA,  dpivot, dB, ldB, strideB,                   &
     &      dinfo, batchCount)                                           &
     &      bind(c,name='hipblasZgetrsStridedBatched_')
...
#endif
        end subroutine hipblasZgetrsStridedBatched


        subroutine hipblasZgetrfStridedBatched( n, dA, ldA, strideA,      &
     &       dpivot, dinfo, batchCount)                                  &
     &       bind(c,name='hipblasZgetrfStridedBatched_')
        use iso_c_binding
        implicit none
...
#endif
        end subroutine hipblasZgetrfStridedBatched
